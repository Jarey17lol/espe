-- Ejercicio 24 Métricas mensuales para 2025
...
--COUNT(id_venta) Cuenta el número de transacciones realizadas en cada mes.
...
--ORDER BY mes Ordena los resultados de enero a diciembre según el número de mes.